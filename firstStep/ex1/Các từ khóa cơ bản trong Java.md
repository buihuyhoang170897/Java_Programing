...
Những từ khóa này là những thành phần cơ bản để xây dựng lên java và cũng cần thiết để bạn xây dựng chương trình Java hiệu quả. Biết cách sử dụng các từ khóa sẽ giúp bạn hiểu cách Java được tạo ra và viết mã nguồn sạch, dễ bảo trì.